      ...
      <div className="row">
        <div className="col-md-4 stretch-card grid-margin">
          <div className="card bg-gradient-success card-img-holder text-white">
            <div className="card-body">
              ...
              <h4 className="font-weight-normal mb-3" id="hdvalue">Project Value<i className="mdi mdi-cash-multiple mdi-24px float-right" />
              </h4>
              <h2 className="mb-5"><i className="mdi mdi-currency-inr" /> {balance.total}</h2>
        ...
        <div className="col-md-4 stretch-card grid-margin">
          <div className="card bg-gradient-info card-img-holder text-white">
            <div className="card-body">
              <img src="/dashboard/assets/images/dashboard/circle.svg" className="card-img-absolute" alt="circle-image" />
              <h4 className="font-weight-normal mb-3"> Paid Amount<i className="mdi mdi-cash-usd mdi-24px float-right" />
              </h4>
              <h2 className="mb-5"><i className="mdi mdi-currency-inr" /> {balance.paid}</h2>
        ...
        <div className="col-md-4 stretch-card grid-margin">
          <div className="card bg-gradient-danger card-img-holder text-white">
            <div className="card-body">
              <img src="/dashboard/assets/images/dashboard/circle.svg" className="card-img-absolute" alt="circle-image" />
              <h4 className="font-weight-normal mb-3"> Balance Amount<i className="mdi mdi-cash mdi-24px float-right" />
              </h4>
              <h2 className="mb-5"><i className="mdi mdi-currency-inr" /> {balance.balance}</h2>
