        ...
        <div className="card-body">
          ...
          <div className="form-row">
            <div className="form-group col-md-6">
              ...
              <div class="row">
                <div className="form-group col-md-6">
                  <input class="form-check-input" type="checkbox" checked={state === "online"} onChange={() => {setState("online");onlinestatus()}} />
                  <p>Online</p>
                </div>
                <div className="form-group col-md-6">
                  <input class="form-check-input" type="checkbox" checked={state === "onsite"} onChange={(checked) => {setState("onsite");onsitestatusget()}} />
                  <p>Onsite</p>
                </div>
              </div>
            </div>
          </div>
          {
            state === 'online' ?
                    ...
                    <div className="form-group col-md-6">
                      <p><label>
                        <input type="radio" className="form-check-input" name="onlinemeeting" value="Google meet"
                          {...register("onlinemeeting")} disabled={!isEditable} />
                        Google meet
                      </label>
                      </p>
                      <p>
                ...
                <div className="form-row">
                  ...
                  <div className=" form-group col-md-6">
                    ...
                    <input type="date" className="form-control" placeholder="YYYY" name="onlinedate"
                      ...
                      aria-invalid={errors?.onlinedate ? "true" : "false"} disabled={!isEditable} />
                  ...
                  <div className="form-group col-md-6">
                    ...
                    <input type="text" className="form-control" name="onlinehours" placeholder="Number of hours"
                      ...
                      aria-invalid={errors?.onlinehours ? "true" : "false"} disabled={!isEditable} />
              ...
              <form className="form-sample" onSubmit={handleSubmit(onSubmitonsitecreate)} >
                ...
                <div className="form-row">
                  ...
                  <div className=" form-group col-md-6">
                    ...
                    <input type="date" className="form-control" placeholder="YYYY" name="onsitedate"
                      ...
                      aria-invalid={errors?.onsitedate ? "true" : "false"} disabled={!isEditables} />
                  ...
                  <div className="form-group col-md-6">
                    ...
                    <input type="text" className="form-control" name="onsitedays" placeholder="Number of days"
                      ...
                      aria-invalid={errors?.onsitedays ? "true" : "false"} disabled={!isEditables} />
                ...
                <div class="form-row">
                  <div className="form-group col-md-6">
                    ...
                    <input type="text" className="form-control" name="textusername" placeholder="Place"
                      ...
                      aria-invalid={errors?.onsiteplace ? "true" : "false"} disabled={!isEditables} />
                  ...
                  <div className="form-group col-md-6">
                    ...
                    <input type="text" className="form-control" name="expensive" placeholder="Training Expansive"
                      ...
                      aria-invalid={errors?.expensive ? "true" : "false"} disabled={!isEditables} />
                ...
                <div className="text-center">
                  <button type="submit" class="btn btn-gradient-light" onClick={toggleEditabilities} value="Submit" >
                    {isEditable ? 'Save' : 'Edit'}
                  </button>
                  </div>
