                  ...
                  <div className="card-body">
                    <form className="form-sample">
                     <div className="form-group">
                      ...
                      {paymentStatus == 'Completed' ? <div class="alert alert-success">Payment<strong> Paid.</strong></div> : <div class="alert alert-danger">Payment is <strong>Pending.</strong></div>}
